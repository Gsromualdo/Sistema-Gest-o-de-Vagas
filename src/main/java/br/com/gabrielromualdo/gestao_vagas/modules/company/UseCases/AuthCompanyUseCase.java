...
import br.com.gabrielromualdo.gestao_vagas.modules.company.dto.AuthCompanyDTO;
import br.com.gabrielromualdo.gestao_vagas.modules.company.dto.AuthCompanyResponseDTO;
...
public class AuthCompanyUseCase {
    ...
    public AuthCompanyResponseDTO execute(AuthCompanyDTO authCompanyDTO) throws AuthenticationException {
        ...
        if (!passwordMatches) {
            // Lança exceção de credenciais inválidas (filha de AuthenticationException)
